...
public class EnhancedAccount {
    ...
    public EnhancedAccount(String accountNumber, String name, int age, double balance, String accountType, String status, String pin) {
    ...
    public boolean withdraw(double amount, String enteredPin) {
        ...
        if(!validatePin(enteredPin)) return false;
        if(!this.status.equalsIgnoreCase("ACTIVE")) return false;
