...
import com.gdb.domain.EnhancedAccount;

public class EnhancedTestAccount {
    public static void main(String[] args) {
        System.out.println("=== Activity 3: Enhanced Account Test ===");
        EnhancedAccount acc = new EnhancedAccount("ACC1001", "Rajesh Sharma", 28, 5000.0, "SAVINGS", "ACTIVE", "1234");
